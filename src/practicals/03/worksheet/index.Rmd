...
In the last tutorial you learned about how you can use **R Project Files** to keep your work organised. You should have already created a **Project file** before this practical, but if you haven't then you should create one now. Open the info box below if you need help doing this.
...
Write out the path relative to the **R Project file**
