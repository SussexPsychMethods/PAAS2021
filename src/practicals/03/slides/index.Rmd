...
- Having the week **leading** up to the pratical being the week in which you
...
_What you should already know how to do_: Create an **R Studio** project file
according to the instructions in the **tutorial**

- Create an RStudio project (or open one you've already made)
