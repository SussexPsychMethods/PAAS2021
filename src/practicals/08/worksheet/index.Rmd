...
practical](https://paas.netlify.app/practicals/06_packages_functions/worksheets/).
:::
...
We're not going to cover how to make **pretty formatted tables** this year. At
least not in detail, but for this task we'll just do something very basic. 
