...
1. In the groups you'll come up with set of instructions for drawing a specific
   picture (I'll tell you what the picture will be in a second)

2. Once you've come up with the instructions then one of the tutors will follow
   those instructions and will hopefully produce the desired picture!
