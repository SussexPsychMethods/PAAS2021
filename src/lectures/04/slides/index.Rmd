---
title: "Lecture 4: Quantitative Research"
subtitle: "The what, the why & the how"
author: "Dr Danielle Evans (& Dr Milan Valášek)"
...
library(metathis)
meta() %>%
  meta_description("Quantitative Research, Measurement, and Variables") %>%
  meta_tag("week" = "04") %>%
  meta_tag("content_type" = "lecture-slides")
```
...
```{r, echo = F, fig.align='center', out.width="55%", fig.alt="Image of two dogs nodding in agreement."}
knitr::include_graphics("https://media.giphy.com/media/BBVykhWmtlvAHvU8DC/giphy.gif")
```
...
### *Not necessarily...* `r emo::ji("person_shrugging")`
...
Then as they walk out we hear them say **'I could *kill* for an ice cream'** `r emo::ji("cold_sweat")`
...
- We didn't control our **IV** appropriately: we often changed the brand, the flavour of ice cream, & the amount given - one day we ran out so had to use frozen yoghurt...
