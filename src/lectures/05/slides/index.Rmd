  ...
  list(
    ...
    "div.footnote" = list(
      ...
      "margin-bottom" = "-40px"
       ...
       "a" = list("text-decoration" = "underline", "font-size" = "95%")
  )
)
```
...
.center[<a href="https://journals.sagepub.com/doi/10.1177/2515245920903079"><img src="./assets/header_joint.png" width="75%" /></a>]
...
Don't forget about the weekly quizzes! There's still a lot of people not doing
them!

And don't forget that you have an extra ethics lecture next week
