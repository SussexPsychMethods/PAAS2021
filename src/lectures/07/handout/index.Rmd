...
In [Lecture\ 4](https://paas.netlify.app/lectures/04/slides) we started talking about how quantitative methodology deals with measurable things (variables) and aims to explain and predict the world around us by modelling relationships between these things.
...
Similarly, as discussed in [Lecture\ 6](https://paas.netlify.app/lectures/06/handout#processes-giving-rise-to-normal-distributions), height in humans is _normally_ distributed, while the distribution of wealth is, once again, heavily _skewed_ to the right.
...
For that reason, the best thing we can do is calculate the mean of our sample and make _inferences_ about the likely value of the population mean, as discussed in [Lecture\ 6](https://paas.netlify.app/lectures/06/handout#the-relationship-between-samples-and-populations).
...
The problem with samples, as discussed in [Lecture\ 6](https://paas.netlify.app/lectures/06/handout#processes-giving-rise-to-normal-distributions), is that **we cannot be sure that our sample accurately represents the population**.
