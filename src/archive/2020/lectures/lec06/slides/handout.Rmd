...
```{r box4, fig.cap="An example normal distribution. It is described by two parameters. The &mu; parameter controls where it is centred and the &sigma; parameter controls how wide it is."}
